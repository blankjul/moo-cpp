...
namespace moo {
    ...
    public:
        ...
        void init_() {
            ...
            if (T >= populationSize) throw std::runtime_error("Please set T lower than population size!");
            ...
            for (int i = 0; i < pop.size(); ++i) fitness[i] = getFitness(weights[i], pop[i]->getOutput());
        }
        ...
        void next_() {
            ...
            //for (int k = 0; k < fitness.size(); ++k) std::cout << fitness[k] << std::endl;
